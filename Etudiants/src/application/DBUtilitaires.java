...
public class DBUtilitaires {
		...
		private static final String connStr="jdbc:mysql://lessonplus.com:3306/lessonpl_danylo?"
		...
		public static void dbConnect() throws SQLException,ClassNotFoundException
		{
			...
			try {
				...
				connection=DriverManager.getConnection(connStr, "lessonpl_danylo", "monPass123!");
			}
